...
-- Script date 25/2/2023 4:40:15 PM
...
--
-- Table quachcanh_qvc_task.project does not contain any data (it is empty)
...
--
-- Table quachcanh_qvc_task.job does not contain any data (it is empty)

-- 
-- Dumping data for table employee
--
-- Table quachcanh_qvc_task.employee does not contain any data (it is empty)

-- 
-- Dumping data for table department
--
-- Table quachcanh_qvc_task.department does not contain any data (it is empty)
