...
-- Script date 9/3/2023 3:56:49 AM
...
--
-- Table trang_qvc_task.project does not contain any data (it is empty)
...
--
-- Table trang_qvc_task.job does not contain any data (it is empty)

-- 
-- Dumping data for table employee
--
-- Table trang_qvc_task.employee does not contain any data (it is empty)

-- 
-- Dumping data for table department
--
-- Table trang_qvc_task.department does not contain any data (it is empty)
...
--
-- Table trang_qvc_task.assign does not contain any data (it is empty)
